...
import pl.edu.atar.recruitment.service.MailXService;
...
public class Mail {
    ...
    public Mail(int mailTemplate, String recipientName, String recipientEmail, Hashtable parameters, int id) {
    ...
    public boolean sendMail(String smtpHost, String user, String password, String senderMail, String senderName) throws Exception {

        MailXService mail2Send = new MailXService(smtpHost, user, password, senderMail, senderName);
        String subject = "";
        String contentBody = "";
